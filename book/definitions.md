...
Sea Ice Concentration {term}`SIC`
...
Multi Year Ice Fraction {term}`MYIF`
...
Advanced Microwave Scanning Radiometer 2 {term}`AMSR2`
...
Advanced Microwave Scanning Radiometer EOS {term}`AMSR-E`
