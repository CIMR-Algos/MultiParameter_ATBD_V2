...
function get_amsr2_tbs(fn)
    dd = h5open(fn)
    V89 = read(dd, "Brightness Temperature (89.0GHz-A,V)")[1:2:end, :][:] / 100.0f0
    H89 = read(dd, "Brightness Temperature (89.0GHz-A,H)")[1:2:end, :][:] / 100.0f0
    V6 = read(dd, "Brightness Temperature (6.9GHz,V)")[:] / 100.0f0
    H6 = read(dd, "Brightness Temperature (6.9GHz,H)")[:] / 100.0f0
    V10 = read(dd, "Brightness Temperature (10.7GHz,V)")[:] / 100.0f0
    H10 = read(dd, "Brightness Temperature (10.7GHz,H)")[:] / 100.0f0
    V18 = read(dd, "Brightness Temperature (18.7GHz,V)")[:] / 100.0f0
    H18 = read(dd, "Brightness Temperature (18.7GHz,H)")[:] / 100.0f0
    V23 = read(dd, "Brightness Temperature (23.8GHz,V)")[:] / 100.0f0
    H23 = read(dd, "Brightness Temperature (23.8GHz,H)")[:] / 100.0f0
    V36 = read(dd, "Brightness Temperature (36.5GHz,V)")[:] / 100.0f0
    H36 = read(dd, "Brightness Temperature (36.5GHz,H)")[:] / 100.0f0
